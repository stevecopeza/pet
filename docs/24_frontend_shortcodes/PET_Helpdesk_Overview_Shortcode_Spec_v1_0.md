...
- Auto-refresh enabled by default (soft refresh)
...
| `refresh` | int | `60` | Seconds; wallboard should default to 60 |
...
| `show_flow` | bool | `true` | Show team load / queue flow panel |
| `title` | string | `Helpdesk Overview` | Heading label |
| `scope` | string | `support+sla_project` | `support_only` or `support+sla_project` |

### Example usages
- `[pet_helpdesk]`
- `[pet_helpdesk mode="wallboard" refresh="60" team="all" limit_critical="4" limit_risk="4"]`

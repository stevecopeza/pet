...
const AddComponentForm: React.FC<AddComponentFormProps> = ({ type, catalogItems, onSuccess, onCancel, quoteId }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (type === 'product' || type === 'service') {
        // Map to CatalogComponent
        payload = {
          type: 'catalog',
          data: {
            description: type === 'product' ? 'Product Line Item' : 'Service Line Item',
            items: [
              {
                description,
                quantity,
